...
const ServiceDetailPage = () => {
  ...
  // SEO
  useSEO({
    title: service ? `${service.name} - Nolads Engineering` : 'Service Details - Nolads Engineering',
    description: service?.description || 'Expert electrical engineering services in Kenya. Generator installations, power systems design, industrial automation, and maintenance.',
    keywords: service ? `${service.name}, electrical engineering, ${service.category || ''}, Kenya` : 'electrical engineering services, generator installation, power systems',
    ogTitle: service?.name,
    ogDescription: service?.description,
    ogImage: (service as any)?.image,
