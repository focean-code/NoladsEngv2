...
export default function BlogPostPage() {
  ...
  useSEO({
    ...
    structuredData: post ? {
      ...
      "author": {
        "@type": "Person",
        "name": post.author_name || 'Nolads Engineering'
      },
      "publisher": {
        "@type": "Organization",
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://www.noladseng.com/logo/logo1.png"
        }
      },
      "mainEntityOfPage": {
        "@type": "WebPage",
  ...
  const fetchRelatedPosts = async () => {
    ...
    try {
      ...
      if (response.success && Array.isArray(response.data)) {
        setRelatedPosts(
          response.data
            .filter(p => p.slug !== post.slug) // Compare by slug, not ID
            .slice(0, 3)
