...
const AdminPage = () => {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      setAnalyticsData({
        ...
        realTime: { activeUsers: 0, currentPages: [], deviceBreakdown: [], countries: [] },
        conversions: {
          totalConversions: 0,
          conversionRate: 0,
          revenue: 0,
  ...
  const renderDashboard = () => {
    ...
    ].map((month, i) => ({ month, newProducts: [2,3,5,4,6,7,3,2,4,5,6,7][i] }));
      ...
      <div className="space-y-8">
            ...
            <CardContent className="p-6">
              ...
              <ResponsiveContainer width="100%" height={250}>
                <LineChart data={monthlyData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="newProducts" stroke="#60a5fa" dot={false} name="New Products" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </ModernCard>
        ...
        <ModernCard className="card-md">
          <CardContent className="p-6">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={topProducts.map((p) => ({ name: p.name, price: p.price || 0 }))}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="name" />
                <YAxis />
                <Tooltip />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${service.is_active
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${product.stock_quantity > 0
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${msg.status === "unread"
                            ? "bg-red-100 text-red-800"
                            : msg.status === "replied"
                              ? "bg-green-100 text-green-800"
                              : "bg-blue-100 text-blue-800"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${quote.status === "pending"
  ...
  const renderAnalytics = () => (
    <div className="space-y-8">
      ...
      <ModernCard>
        <CardContent className="p-6">
          <h3 className="font-bold mb-4">PostHog Analytics Overview</h3>
          <div className="space-y-4">
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                PostHog analytics is active and providing real-time insights.
                View page traffic, user engagement metrics, and event data
                below.
              </p>
            </div>
          </div>
                  ...
                  {analyticsData.conversions?.goalCompletions?.map(
                    (goal, i) => (
                      ...
                      >
                        <div className="flex items-center">
                          <CheckCircle
                            className={`w-5 h-5 mr-3 ${goal.completions > 0
                                ? "text-emerald-500"
                                : "text-slate-300"
                              }`}
                          />
            ...
            <div className="flex flex-wrap gap-2 sm:gap-8">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 py-2 sm:py-4 border-b-2 font-medium text-xs sm:text-sm transition-colors ${activeTab === tab.id
